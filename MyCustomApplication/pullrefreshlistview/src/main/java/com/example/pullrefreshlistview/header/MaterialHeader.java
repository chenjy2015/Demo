package com.example.pullrefreshlistview.header;
...
import com.example.pullrefreshlistview.PtrUIHandler;
import com.example.pullrefreshlistview.PtrUIHandlerHook;
...
public class MaterialHeader extends View implements PtrUIHandler {
     ...
     *
     * @param frame
     * @param mIsRefreshSuccess
     */
    @Override
    public void onUIRefreshComplete(PtrFrameLayout frame, boolean mIsRefreshSuccess) {
        mDrawable.stop();
    }
