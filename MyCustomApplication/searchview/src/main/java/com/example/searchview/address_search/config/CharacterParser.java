package com.example.searchview.address_search.config;
...
public class CharacterParser {
    ...
    public CharacterParser(Context context){
        mContext = context;
...
//				}
    ...
    public HashMap<String, String> initDictionary(){
        ...
        try{
            inputReader = new InputStreamReader(mContext.getResources().getAssets().open(fileName),"UTF-8");
