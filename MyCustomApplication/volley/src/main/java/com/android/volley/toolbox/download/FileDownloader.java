 ...
 * <p/>
 * Usage: like {@link }, the best way to use this class is create by {@link RequestQueue}
 * and stand Singleton, just get the only one instance to do everything in anywhere.
 * To start a new download request, invoke the {@link #add(String, String, FileDownLoadListener)}
...
public class FileDownloader {
     ...
     */
    public DownloadController add(File storeFile, String url, FileDownLoadListener<Void> listener) {
    ...
    /**
     * @see {@link #add(File, String, FileDownLoadListener)}
     */
    public DownloadController add(String storeFilePath, String url, FileDownLoadListener<Void> listener) {
    ...
    public class DownloadController {
        ...
        private FileDownLoadListener<Void> mListener;
        ...
        private DownloadController(String storeFilePath, String url, FileDownLoadListener<Void> listener) {
            this(new File(storeFilePath), url, listener);
        }

        private DownloadController(File storeFile, String url, FileDownLoadListener<Void> listener) {
        ...
        private boolean deploy() {
            ...
            mRequest.setFileDownLoadListener(new FileDownLoadListener<Void>() {
                boolean isCanceled;
