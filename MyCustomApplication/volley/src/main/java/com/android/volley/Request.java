...
public abstract class Request<T> implements Comparable<Request<T>> {
     ...
     */
    private final HashMap<String, String> mHashHeaders;
    ...
    /**
     * Prepare to execute, invoke before {@link com.android.volley.toolbox.HttpStack#performRequest(Request, Map)} .
     ...
     * However the {@link com.vincestyling.netroid.request.FileDownloadRequest}
     ...
     */
    public byte[] handleResponse(ByteArrayPool mPool,HttpResponse response,ResponseDelivery delivery) throws IOException, ServerError {
        // Some responses such as 204s do not have content.
        if (response.getEntity() != null) {
            return HttpUtils.responseToBytes(mPool,response);
        } else {
